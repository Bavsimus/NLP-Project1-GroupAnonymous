...
print("-" * 50)
print("=== Step 3: Classification with Logistic Regression ===")
...
# A. Logistic Regression + N-grams (Counts)
print("\n--- Model: Logistic Regression + N-grams (Counts) ---")
log_model.fit(X_train_ngrams, y_train)
y_pred_ngrams = log_model.predict(X_test_ngrams)
...
y_pred_tfidf = log_model.predict(X_test_tfidf)
