...
# --- Step 3: Classification with Decision Tree ---
print("--- Step 3: Classification with Decision Tree ---")
dt_model = DecisionTreeClassifier(
    max_depth=50,
    random_state=42
)

# Model 3.A: Decision Tree + N-grams (Counts)
print("\n--- Model: Decision Tree + N-grams (Counts) ---")
dt_model.fit(X_train_ngrams, y_train)
y_pred_dt_ngrams = dt_model.predict(X_test_ngrams)

print(f"Accuracy: {accuracy_score(y_test, y_pred_dt_ngrams):.4f}")
print("Classification Report:")
print(classification_report(y_test, y_pred_dt_ngrams))


# Model 3.B: Decision Tree + TF-IDF
print("\n--- Model: Decision Tree + TF-IDF ---")
dt_model.fit(X_train_tfidf, y_train)
y_pred_dt_tfidf = dt_model.predict(X_test_tfidf)

print(f"Accuracy: {accuracy_score(y_test, y_pred_dt_tfidf):.4f}")
print("Classification Report:")
print(classification_report(y_test, y_pred_dt_tfidf))
print("-" * 50)
print("Decision Tree models completed.")